<?php 
                ...
                <div class="widget-content">
                  <div class="padd">
					...
					<?php 
						...
						$wilkop = mysql_fetch_array(mysql_query("select * from pengaturan where kode_koperasi = '$managerWil'"));
					...
					<div class="form-group">
					  ...
					  <div class="col-lg-4">
						<input type="hidden" name="kode" value="<?php echo $wilkop[kode_koperasi]; ?>" class="form-control">
					...
					<div class="form-group">
					  ...
					  <div class="col-lg-8">
					   <textarea class="form-control" rows="2" name="alamat" placeholder="Alamat Lengkap sesuai KTP Anggota"></textarea>
					   </div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
					  ...
					  <div class="col-lg-5">
						<input type="text" class="form-control"  autocomplate="off"  name="email" placeholder="Alamat email Aktif">
					  </div>
					</div>
					...
					<div class="form-group">
					  ...
					  <div class="col-lg-4">
						<input type="text" class="form-control"  autocomplate="off"  name="pekerjaan" placeholder="Sebenarnya" >
					  </div>
					  <div class="col-lg-4">
					  ...
					  <div class="col-lg-8">
						...
						<?php 
							...
							while ($row = mysql_fetch_array($provinsi)){
								echo "<option value='$row[namaProvinsi]'>$row[namaProvinsi]</optioin>";
							}
	...
	elseif($m=='aktif'){
		...
		$update = "UPDATE petugas SET s = 'Aktif'
			...
			$dpetugas  = mysql_query("select * from petugas where idPetugas = '$dos'");
				...
				if($doUpdate){
					echo '<div class="alert alert-success">
						<h4>Berhasil Petugas Baru sudah di Aktifkan.! [User : ID Petugas dan Password : No Telepon Petugas] </h4></div>';
					echo '<META HTTP-EQUIV="Refresh" Content="3; URL=?modul=petugas">';
	...
	elseif($m =='update'){
		...
		if($updateOK){
			...
			echo '<META HTTP-EQUIV="Refresh" Content="1; URL=?modul=petugas">';
		}
		else{
			echo "gagal";
		}
					...
					<div class="table-responsive">
						<table class="table table-striped table-bordered table-hover">
						  ...
						  <tbody>
								<?php 
									$nomor=1;
									$ptgs = mysql_query("select * from petugas where level > 1");
