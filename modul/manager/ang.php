                     ...
                     <form autocomplete="off" class="form-horizontal" role="form" method="POST" action = "?modul=anggota&act=add">
							...
							<div class="form-group">
							  ...
							  <div class="col-lg-8">
								...
								<input type="hidden" name="kodekoperasi" class="form-control" value="<?php echo $managerWil;?>">
							...
							<div class="page-tables">
								...
								<div class="table-responsive">
									<table class="table table-striped table-hover table-responsive table-bordered">
										...
										<tbody>
										<?php 
											$tampilAnggota = mysql_query("select * from anggota where kodeKoperasi ='$managerWil'");
											while($row = mysql_fetch_array($tampilAnggota)){
												echo "<tr>
													<td>$row[nama]</td>
