						...
						<div class="table-responsive">
							<table class="table table-striped table-hover table-responsive table-bordered">
							  ...
							  <tbody>
								...
								$list_anggota = mysql_query("select * from anggota inner join pinjamawal on anggota.idAnggota = pinjamawal.idAnggota AND anggota.kodeKoperasi = '$managerWil'");
