			...
			<table cellpadding="0" cellspacing="0" border="0" id="data-table-1" width="100%">
				...
				<?php 
					...
					while ($baca = mysql_fetch_array($lapAnggota)){
						...
						$baru = mysql_fetch_array( mysql_query("select * from anggota ORDER BY idAnggota"));
				echo "<tr>
						  <td>$urut</td>
						  <td>$rekening</td>
						  <td>$baca[nama]</td>
						  ...
						  <td>
										  <a href='?modul=laporan&aksi=mutasitotal&idAnggota=$baca[idAnggota]' >
										  <i class='fa fa-credit-card-alt '>
										  Mutasi
										  </i>
										  </a> 
										  <a href='?modul=laporan&aksi=cetak&idAnggota=$baru[idAnggota]'>Cetak</a>
										  </td>
...
<iframe id='ifrmPrint' src='#' style="width:0px; height:0px;"></iframe>
	...
	<tr>
		<td height="29" colspan="3" align="center"><?php echo $petugas[nama]; ?><br /></td>
	</tr>
</table></div>
		<?php }
		elseif($m =='mutasitotal'){?>
