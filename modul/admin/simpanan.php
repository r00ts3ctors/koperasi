	...
	elseif($m =='proses'){
		...
		$sql=mysql_query("INSERT INTO simpanan VALUES ('','$idanggota','$idpetugas','$kodekoperasi','$kodelayanan','SETOR','$jumlah','','$jasa','$jumlah','$tgl_simpan','$detil_waktu','$ket')");
			...
			if($jumlah > $validasi ){
						?>
							<script type="text/javascript">
								alert("Maaf... tidak bisa melakukan penarikan 
								<?php echo $kode_layanan ?> melebihi periksa kembali ");
		...
		$kas		=mysql_query("INSERT INTO kas VALUES ('','$notransaksi','$tgl_simpan','Simpanan an. $saldo[nama]','$idpetugas','$idanggota',
				...
				// }
				// echo "Masukan  : ".$masukan."<br>";
				// echo "Keluaran : ".$keluaran."<br>";
				// echo "Validasi : ".$validasi."<br>";
										...
										<?php 
											...
											while ($r = mysql_fetch_array($anggota)){
												...
												echo "<tr>
														...
														<td>$saldo</td>
														<td>
															<a href='?modul=simpan&act=input&idAnggota=$r[idAnggota]'>PROSES</a>
														</td>
														</tr>";
