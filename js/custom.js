...
$(document).ready(function(){
  ...
  setTimeout(function() {noty({text: '<strong>Informasi</strong>',layout:'topRight',type:'information',timeout:15000});}, 7000);

  setTimeout(function() {noty({text: 'Aplikasi Koperasi Pertama di Indonesia yang melayani anggota secara online semoga sukses',layout:'topRight',type:'alert',timeout:13000});}, 9000);
